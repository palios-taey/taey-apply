...
REQUIRED_FILES = {
    ...
    "src/taey_apply/application_action_compiler.py",
    "src/taey_apply/application_contract.py",
    "src/taey_apply/application_execute_cli.py",
    "src/taey_apply/application_executor.py",
    ...
    "tools/validate_application_action_compiler.py",
    "tools/validate_application_executor.py",
